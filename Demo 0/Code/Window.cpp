...
void InitGraphics(){ 
  ...
  /*
  --- Removed text and added two rectangle placeholders for clues and briefcase
  */
  Rectangle(hdc, 50, 200, 670, 530); // xTopLeft, yTopLeft, xBottomRight, yBottomRight
  Rectangle(hdc, 740, 0, 1024, 768); // xTopLeft, yTopLeft, xBottomRight, yBottomRight
  DeleteObject(hBrush);

  //draw white text
  SetTextColor(hdc, RGB(25, 255, 255)); //white text 
